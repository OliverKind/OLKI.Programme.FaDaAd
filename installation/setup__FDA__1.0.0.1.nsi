;NSIS Installer for FDA 1.0.0.1
...
Section ""
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${Company} ${AppName}" "DisplayIcon" '$INSTDIR\1380_wall_clockFINAL.ico'
