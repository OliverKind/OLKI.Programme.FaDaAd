...
I use [SemVer](http://semver.org/) for versioning and addiong an counting buildnumber. For the versions available, see the [tags on this repository](https://github.com/OliverKind/OLKI.Programme.FDA/tags). 
